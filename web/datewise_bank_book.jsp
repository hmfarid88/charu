        ...
        %>
            <%
                ...
                try {
                    ...
                    String query = "select AMOUNT, BRANCH, PAYER, DATE from bank_transition where TYPE='Deposit' and BANK=? and DATE between '" + date1 + "' and '" + date2 + "' and DATE>'2020-11-09' UNION "
                            + "select AMOUNT, BRANCH, RETAILER, DATE from customer_pay where PAY_TYPE= 'Bank' and BANK_NAME=? and DATE between '" + date1 + "' and '" + date2 + "' and DATE>'2020-11-09' order by DATE";
                    ps = con.prepareStatement(query);
                    ps.setString(1, bank);
                    ps.setString(2, bank);
                    rs = ps.executeQuery();
                    String query1 = "select AMOUNT, BRANCH, PAYER, DATE from bank_transition where TYPE='Withdraw' and BANK=? and DATE between '" + date1 + "' and '" + date2 + "' and DATE>'2020-11-09' order by DATE";
                    ps = con.prepareStatement(query1);
                    ps.setString(1, bank);
                    rs1 = ps.executeQuery();
                    String query2 = "select sum(AMOUNT) from bank_transition where TYPE='Deposit' and BANK=? and DATE between '" + date1 + "' and '" + date2 + "' and DATE>'2020-11-09'";
                    ps = con.prepareStatement(query2);
                    ps.setString(1, bank);
                    rs2 = ps.executeQuery();
                    rs2.next();
                    request.setAttribute("totaldeposit", rs2.getDouble(1));
                    String query3 = "select sum(AMOUNT) from bank_transition where TYPE='Withdraw' and BANK=? and DATE between '" + date1 + "' and '" + date2 + "' and DATE>'2020-11-09'";
                    ps = con.prepareStatement(query3);
                    ps.setString(1, bank);
                    rs3 = ps.executeQuery();
                    rs3.next();
                    request.setAttribute("totalwithdraw", rs3.getDouble(1));
                    String query4="select sum(AMOUNT) from customer_pay where PAY_TYPE= 'Bank' and BANK_NAME=? and DATE between '" + date1 + "' and '" + date2 + "' and DATE>'2020-11-09'";
