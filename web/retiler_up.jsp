...
<html class="no-js" lang="">
    ...
    <div class="container"><br>
        <form method="POST" action="RtpayUpdateServlet" class="form-inline">
            <div class="row">
                <div class="col-sm-3">

                </div>
                <div style="background-color: #CCC" class="col-sm-6">
                    <table><center><h4>Retailer Payment Update</h4></center>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <br><label>Collected By : </label>
                            </td>
                            <td>
                                <br><input type="text" name="cby"   class="form-control input-sm" value="${collectby}" required="" >
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <br> <input type="submit" class="btn btn-success input-sm" value="Update"> <a href="retailer_ledger.jsp" class="btn btn-primary btn-sm">Cancel</a> 
                            </td>
                        </tr>
                    </table><br>
     ...
     <div class="col-sm-6" style="background-color: #CCC">
        ...
        <form  method="POST" action="RetPayDelServlet" class="form-inline">
