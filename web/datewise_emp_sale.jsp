    ...
    <br> <center><h3> You are not logged in</h3><br/>
        ...
        <%
            ...
            try {
                ...
                String query = "select ORDER_NAME, PRODUCT_NAME, QTY, RATE, PAYMENT, DATE from order_delevery where DATE between '" + date1 + "' and '" + date2 + "' and SP_NAME=? order by DATE";
                ps = con.prepareStatement(query);
                ps.setString(1, spname);
                rs = ps.executeQuery();
                String query1 = "select sum(QTY), sum(QTY*RATE), sum(PAYMENT) from order_delevery where DATE between '" + date1 + "' and '" + date2 + "' and SP_NAME=?";
