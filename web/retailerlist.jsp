                    ...
                    <table  border="2" width="100%" class="table-striped table-responsive">
                        <thead>
                            <tr style="background-color: #CCCCCC">
                                ...
                                <th style="text-align: center">Proprietor</th>
                                <th style="text-align: center">Thana</th>
                                <th style="text-align: center">Zilla</th>
                                <th style="text-align: center">Area</th>
                                <th style="text-align: center">Manager Name</th>
                                <th style="text-align: center">Mobile Number</th>
                                <th style="text-align: center">Birth Day</th>
                                <th style="text-align: center">Marriage Day</th>
                            </tr>
                        </thead>
                        <tbody id="myTable">
                            <%
                            ...
                            <tr>
                                ...
                                <td style="text-align: center"><%= am.getProname()%></td>
                                <td style="text-align: center"><%= am.getThana()%></td>
                                <td style="text-align: center"><%= am.getZilla()%></td>
                                <td style="text-align: center"><%= am.getArea()%></td>
                                <td style="text-align: center"><%= am.getManager()%></td>
                                <td style="text-align: center"><%= am.getMnumber()%></td>
                                <td style="text-align: center"><%= am.getDob()%></td>
                                <td style="text-align: center"><%= am.getDom()%></td>
                            </tr>
                            <% }%>
                        </tbody>
                        <tfoot>
