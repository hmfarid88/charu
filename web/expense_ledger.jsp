                    ...
                    <table  border="2" width="100%" class="table-striped table-responsive">
                        ...
                        <tbody>
                            <%
                                ...
                                Accountant acc = ap.TotalExpense();
                            ...
                            <tr>
                                ...
                                <td style="text-align: center"><%= ac.getCostname()%></td>
                                <td style="text-align: center"><%= ac.getCostamount()%></td>
                            </tr>
                            <% }%>
                            <tr style="background-color: #CCC">
                                ...
                                <th style="text-align: center"><%= acc.getCosttotal()%></th>
                            </tr>
