    ...
    <br> <center><h3> You are not logged in</h3><br/>
        ...
        <%
            ...
            try {
                ...
                String query = "select RETAILER, PRODUCT_NAME, TRUCK_NO, QTY, RENT, PAYMENT, NOTE, DATE, TRANSPORT_NAME, SI_NO from transport_pay where YEAR(DATE) = YEAR(CURRENT_DATE()) AND MONTH(DATE) = MONTH(CURRENT_DATE()) and TRANSPORT_NAME=?";
                ps = con.prepareStatement(query);
                ps.setString(1, transport);
                rs = ps.executeQuery();

                String query1 = "select sum(QTY), sum(RENT), sum(PAYMENT) from transport_pay where YEAR(DATE) = YEAR(CURRENT_DATE()) AND MONTH(DATE) = MONTH(CURRENT_DATE()) and  TRANSPORT_NAME=?";
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div id="datewise" class="collapse" style="margin: 10px 15px">
                                    <form method="POST" action="datewise_transportLedger.jsp" class="form-inline">
