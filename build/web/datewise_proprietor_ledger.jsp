...
<html>
    ...
    <br> <center><h3> You are not logged in</h3><br/>
        ...
        try {
            ...
            String query = "select PAY_NAME, NOTE, PAYMENT, RECEIVE, DATE, SI_NO from proprietor_cost where DATE between '"+ date1 +"' and '"+ date2 +"'";
            ps = con.prepareStatement(query);
            rs = ps.executeQuery();
            String paytotal="select sum(PAYMENT), sum(RECEIVE) from proprietor_cost where DATE between '"+ date1 +"' and '"+ date2 +"' ";
            ps = con.prepareStatement(paytotal);
            rs1 = ps.executeQuery();
            rs1.next();
            request.setAttribute("totalpay", rs1.getLong(1));
            request.setAttribute("totalrecv", rs1.getLong(2));
            %>
                    ...
                    <table  border="2" width="100%" class="table-striped table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center"><%= rs.getLong(3) %></td>
                                <td style="text-align: center"><%= rs.getLong(4) %></td>
                                <td style="text-align: center"><%= rs2.getLong(1)+rs.getLong(3)-rs.getLong(4) %></td>
                            </tr>
                            <% }} %>
                            <tr style="background-color: #CCC">
                                ...
                                <th style="text-align: center">${totalrecv}</th>
                                 <th style="text-align: center"></th>
                            </tr>
                             <%
