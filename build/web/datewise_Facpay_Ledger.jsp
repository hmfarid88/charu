    ...
    <br> <center><h3> You are not logged in</h3><br/>
        ...
        <%
            ...
            try {
                ...
                String query = "select COMPANY_NAME, PAY_TYPE, NOTE, AMOUNT, BANK_NAME, BRANCE_NAME, CHEQUE_NO, PAYER, DATE, SI_NO from company_payment where DATE between '" + date1 + "' and '" + date2 + "'";
            ...
            <table border="2" width="100%" class="table-striped table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center"><%= rs.getString(1) %> (<%= rs.getString(3) %>)</td>
                        ...
                        <td style="text-align: center">
                             <form  method="POST" action="FcpSelectServlet" class="form-inline">
                                <input type="hidden" value="<%= rs.getInt("SI_NO")%>" name="fpsi">
