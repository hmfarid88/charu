        ...
        <div class="container-fluid">
            ...
            <div id="div_print" style="font-family: fontawesome">
                <center><h2><b>CHARU ENTERPRISE</b></h2>
                    ...
                    <h5>Date : ${param.date1} TO ${param.date2} </h5>
                </center>
            ...
            request.setAttribute("date2", date2);
                ...
                try {
                    ...
                    String query = "select distinct MONTH(DATE), MONTHNAME(DATE), YEAR(DATE) from order_delevery where DATE between '"+date1+"' and '"+date2+"' order by DATE";
