    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String transportname=request.getParameter("transportname");    
            ...
            try {
                ...
                String query1="select count(*) from transport_name where TRANSPORT_NAME=?";
                ...
                String query="insert into transport_name(TRANSPORT_NAME) value (?)";
                ...
                int b = ps.executeUpdate();
                    if (b > 0) {
                        ...
                        out.println("Factory is not Entryed");
                    }
                        }
            } catch (Exception ex) {
              ex.printStackTrace();
