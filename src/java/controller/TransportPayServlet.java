 ...
 * @author Acer
 */
public class TransportPayServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try{
            ...
            String query = "insert into transport_pay(TRANSPORT_NAME, PAYMENT, NOTE, DATE) values(?,?,?, CURDATE())";
            ...
            out.println("Payment is no completed !");
                }
