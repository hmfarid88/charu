 ...
 * @author Acer
 */
public class AccIDPassUpServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
                ...
                String update="update userinfo set USER_ID=?, PASSWORD=? where USER_TYPE='Accountant' and PHONE_NUMBER=? and USER_ID=? and PASSWORD=?";
