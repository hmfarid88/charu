 ...
 * @author Acer
 */
public class FacPayDelServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PreparedStatement ps = null;
         ...
         try{
             ...
             String qury = "delete from company_payment where SI_NO=?";
             ps = con.prepareStatement(qury);
             ps.setInt(1, sino);
             int a = ps.executeUpdate();
             if (a > 0) {
                 String qury1 = "delete from factory_stock where SI_NO=?";
             ps = con.prepareStatement(qury1);
             ps.setInt(1, delno);
             int b=ps.executeUpdate();
             if(b>0){
                 out.println("Delete Success");
             }else{
              out.println("Delete Not Success");   
             }
             }else{
               out.println("Delete Not Success");    
             }
