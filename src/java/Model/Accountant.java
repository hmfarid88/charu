...
public class Accountant {
    ...
    public int getTotaldqty() {
        return totaldqty;
    }

    public void setTotaldqty(int totaldqty) {
    ...
    public Long getTotaltrent() {
        return totaltrent;
    }

    public void setTotaltrent(Long totaltrent) {
        this.totaltrent = totaltrent;
    }

    public String getTpproduct() {
        return tpproduct;
    }

    public void setTpproduct(String tpproduct) {
